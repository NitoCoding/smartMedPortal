<div>
  ...
  <form class="space-y-4 md:space-y-6" wire:submit="update">
    ...
    <div class="grid md:grid-cols-3 md:gap-6">
        <div class="relative z-0 w-full mb-5">
          <label for="medicine" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Medicine</label>
        ...
        <div class="relative z-0 w-full mb-5">
          <label for="kuantitas" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kuantitas</label>
          <input type="number" name="kuantitas" id="kuantitas"
            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="1-9" required="" wire:model="form.kuantitas.0">

        </div>
        <div class="relative z-0 mb-5 jusitfy-end">

    ...
    <form class="space-y-4 md:space-y-6" wire:submit="store">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            <div class="relative z-0 w-full mb-5">
                ...
                @can('Dokter')
                <input type="text" name="dokter" id="dokter" wire:model.live="data.dokterId" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" disabled>
                ...
                <select id="dokter" name="dokterId" wire:model.live="data.dokterId"
                    ...
                    <option value="" disabled selected>choose dokter</option>
            ...
            <div class="relative z-0 w-full mb-5">
                ...
                <select id="pasien" name="pasienId" wire:model.live="data.pasienId"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    `<option value="" disabled selected>choose pasien</option>
